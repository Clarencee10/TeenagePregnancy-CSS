...
<head>
    ...
    <title>About Teenage Pregnancy</title>
    <meta name="description" content="Learn about the causes, risks, and consequences of teenage pregnancy. Understand prevention strategies and support options for pregnant teenagers.">
    <meta name="keywords" content="teenage pregnancy, causes, risks, consequences, prevention strategies, support options">
...
<body>
    <header>
        <div class="container">
            <nav>
                <div class="logo">
                    <img src="./assets/images/PreggyLogo.png" alt="Logo">
                    <h1><em>Preggy Health</em></h1>
                </div>
                <ul>
    ...
    <section id="about" class="about">
        <div class="container">
            <h1>What is Teenage Pregnancy?</h1>
            ...
            <img src="assets/images/pregnant.png" alt="Pregnant Teen">
        </div>
    </section>

    <section id="caues-risks-consequences" class="about">
        <div class="container">
    ...
    <section id="prevention-support" class="about">
        <div class="container">
            <h2>Prevention Strategies and Support Options</h2>
            ...
            <div>
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/yYoyBdtGwx4?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
    ...
    <section id="inspirational-story" class="about">
        <div class="container">
            <h2>Inspirational Story: Overcoming Teenage Pregnancy Challenges</h2>
    ...
    <footer>
        <section id="contact" class="contact-section">
            <div class="contact-section">
                    ...
                    <ul>
                        <li>Email: <a href="mailto:cjbm2022-7360367367@bicol-u.edu.ph">cjbm2022-7360367367@bicol-u.edu.ph</a></li>
                        <li>Phone: +63-9512117647</li>
                        <li>Follow Us: 
